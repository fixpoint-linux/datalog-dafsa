    ...
    div []
        [ Fixpoint.Hero.view
            { prompt =
                ...
                , text " ./dl -d db query 'tc(X,Y) :- edge(X,Y).' tc"
                , Fixpoint.Hero.blink
                ]
            , title =
                [ text "A DAFSA-backed Datalog engine that "
                , Fixpoint.Hero.fx [ text "never forgets itself" ]
                , text "."
                ]
            , tagline =
                [ text "facts → minimal-acyclic-DAFSA → a small VM → mmap’d, versioned snapshots" ]
            }
        , Fixpoint.Section.view
            { id = "time"
            , title = "The headline: time travel"
        ...
        , Fixpoint.Section.view
            { id = "highlights"
            , title = "What else stands out"
            , hint = "// compact · typed · search · order-stats"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "quickstart"
            , title = "Quickstart"
            , hint = "// make && ./dl load/lookup/prefix/query/publish"
            , children =
                [ Fixpoint.Code.block
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// the whole engine in one table"
            , children =
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// language · cli · api · architecture · time-travel · vector-search · order-statistics · typed-projects"
            , children =
                [ ul []
...
languageView =
    div []
        [ Fixpoint.Hero.view
            ...
            , title = [ text "Language Reference" ]
            , tagline = []
            }
        , Fixpoint.Section.view
            { id = "comments"
            , title = "Comments"
            , hint = "// # line comments run to end of line"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "facts"
            , title = "Facts"
            , hint = "// ground predicates, terminated by a full stop"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "vars"
            , title = "Variables, constants, integers and strings"
            , hint = "// A-Z, _, lowercase symbols, double-quoted strings, raw u32 ints"
            , children =
                [ ul []
                    [ li []
        ...
        , Fixpoint.Section.view
            { id = "aggregates"
            , title = "Aggregates"
            , hint = "// N = count() · S = sum(Y) · M = min(Y) / max(Y)"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// concat · length · lower · upper · prefix · suffix · contains"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "lists"
            , title = "Lists"
            , hint = "// cons · car · cdr · append · member · [H | T]"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "variadic"
            , title = "Variadic relations"
            , hint = "// arity 1–8, stored per-arity"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// builtin names you cannot use as a rule head"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "errors"
            , title = "Compile-error semantics"
            , hint = "// loud, compile-time diagnostics"
            , children =
                [ p []
...
cliView =
    div []
        [ Fixpoint.Hero.view
            ...
            , title = [ text "CLI Reference" ]
            , tagline = []
            }
        , Fixpoint.Section.view
            { id = "load"
            , title = "load"
            , hint = "// dl [-d <dir>] load <csv> --rel <name>"
            , children =
                [ p []
                    [ text "The "
                    , Fixpoint.Code.inline "dl"
        ...
        , Fixpoint.Section.view
            { id = "lookup"
            , title = "lookup"
            , hint = "// exact lookup, prints found / not found"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "prefix"
            , title = "prefix"
            , hint = "// bind leading columns, enumerate matching tuples"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "query"
            , title = "query"
            , hint = "// parse, compile, run a rule, stream the goal"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "time"
            , title = "Time travel"
            , hint = "// publish · versions · bound · --version N"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "publish"
            , title = "publish"
            , hint = "// atomically publish a versioned snapshot"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "bound"
            , title = "bound"
            , hint = "// bound query (snapshot path)"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "pattern"
            , title = "pattern"
            , hint = "// enumerate tuples whose full key matches a regex"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "search"
            , title = "search"
            , hint = "// full-text AND-intersect over __postings__"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "vsearch"
            , title = "vsearch"
            , hint = "// semantic vector search: MIH over ITQ + int8 re-rank"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "versions"
            , title = "versions"
            , hint = "// list the published snapshot versions (ascending)"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "scope"
            , title = "What is not in the CLI"
            , hint = "// top-down / QSQ and order-statistics are C-API only"
            , children =
                [ p []
    ...
    div []
        [ Fixpoint.Hero.view
            { prompt =
                ...
                , text " datalog-dafsa "
                , Fixpoint.Hero.dollar
                , text " cc -I src app.c libdatalog.a"
                , Fixpoint.Hero.blink
                ]
            , title = [ text "C API Reference" ]
            , tagline = []
            }
        , Fixpoint.Section.view
            { id = "lifecycle"
            , title = "Lifecycle"
            , hint = "// dl_open · dl_close · dl_open2"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "schema"
            , title = "Schema"
            , hint = "// dl_declare_relation · dl_declare_relation_variadic"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "facts"
            , title = "Facts"
            , hint = "// dl_load_facts · dl_add_fact · dl_delete_fact"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "query"
            , title = "Queries"
            , hint = "// dl_lookup · dl_prefix · dl_query · dl_query_bound · dl_pattern"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "iter"
            , title = "Iterator + merge-join"
            , hint = "// dl_iter_* · dl_merge_join"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// dl_rank · dl_select · dl_range_count · dl_count · _bound · _perm"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "rules"
            , title = "Rules"
            , hint = "// dl_load_rules · dl_compile · dl_query_magic · dl_query_topdown"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "time-travel"
            , title = "Time-travel / as-of"
            , hint = "// dl_snapshot_versions · dl_query_version · dl_set_snapshot_retain"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// dl_search · dl_vector_search · dl_vector_rerank"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "hooks"
            , title = "Fault-injection hooks (test-only)"
            , hint = "// dl_set_fault_hook"
            , children =
                [ table [ class "api" ]
                    [ tbody []
        ...
        , Fixpoint.Section.view
            { id = "interner"
            , title = "Interner"
            , hint = "// dl_intern_str · dl_intern_str_of"
            , children =
                [ table [ class "api" ]
                    [ tbody []
...
architectureView =
    div []
        ...
        , Fixpoint.Section.view
            { id = "storage"
            , title = "The storage thesis: fixed-width big-endian keys"
            , hint = "// one fixed-width key of 4*a bytes per fact"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "per-relation"
            , title = "One DAFSA per relation"
            , hint = "// relation R of arity a_R has its own DAFSA + WAL"
            , children =
                [ p []
                    [ text "Each relation "
        ...
        , Fixpoint.Section.view
            { id = "compact"
            , title = "Why the DAFSA makes the store compact"
            , hint = "// minimized acyclic DFA: shared suffix paths are stored once"
            , children =
                [ p []
                    [ text "The DAFSA is a "
        ...
        , Fixpoint.Section.view
            { id = "lifecycle"
            , title = "Lifecycle: load → compile → publish → serve"
            , hint = "// single-writer / multiple-reader"
            , children =
                [ ol []
                    [ li []
                        [ strong [] [ text "Load" ]
        ...
        , Fixpoint.Section.view
            { id = "durability"
            , title = "Durability"
            , hint = "// WAL + fsync · single-writer lock · interner saved first"
            , children =
                [ p []
                    [ text ""
                    , Fixpoint.Code.inline "dl_add_fact"
        ...
        , Fixpoint.Section.view
            { id = "strategies"
            , title = "Join & evaluation strategies"
            , hint = "// index-nested-loop · semi-naive · bushy · permutation-index · magic-sets · IVM"
            , children =
        ...
        , Fixpoint.Section.view
            { id = "performance"
            , title = "Performance"
            , hint = "// cost tracks the bound prefix, not a full scan"
            , children =
                [ p []
...
timeTravelView =
    div []
        [ Fixpoint.Hero.view
            ...
            , title = [ text "Time Travel" ]
            , tagline = []
            }
        , Fixpoint.Section.view
            { id = "cli"
            , title = "From the CLI"
            , hint = "// publish · versions · --version N"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// dl_snapshot_versions — the two-call idiom"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "asof"
            , title = "As-of queries"
            , hint = "// dl_query_version · dl_query_bound_version"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "retain"
            , title = "Retention"
            , hint = "// dl_set_snapshot_retain — prune-to-N, n==0 keeps all"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// single-writer / multiple-reader on mmap"
            , children =
                [ p []
    ...
    div []
        [ Fixpoint.Hero.view
            { prompt =
                ...
                , text " datalog-dafsa "
                , Fixpoint.Hero.dollar
                , text " dl vsearch 'GPU rental' --k 10"
                , Fixpoint.Hero.blink
                ]
            , title = [ text "Semantic ", Fixpoint.Hero.fx [ text "vector search" ] ]
            , tagline = []
            }
        , Fixpoint.Section.view
            { id = "quickstart"
            , title = "Quickstart"
            , hint = "// opt-in vector tier: ggml submodule + bge-small model"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "how-it-works"
            , title = "How it works"
            , hint = "// binarize -> 256-bit ITQ signature -> m=16 bands -> int8 re-rank"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "cli"
            , title = "The CLI"
            , hint = "// vsearch, vhybrid, and the symbolic search"
            , children =
                [ h3 [] [ text "vsearch" ]
        ...
        , Fixpoint.Section.view
            { id = "dl-embed"
            , title = "dl-embed"
            , hint = "// the C++ embedding tool (ggml-based, real bge-small weights)"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "design"
            , title = "Design"
            , hint = "// MIH over ITQ: competitive with HNSW at ~1e5-1e6 entities"
            , children =
                [ p []
...
orderStatisticsView =
    div []
        ...
        , Fixpoint.Section.view
            { id = "core"
            , title = "rank / select / range_count / count"
            , hint = "// positional queries over a DAFSA's sorted structure"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "bound"
            , title = "Bound variants"
            , hint = "// restrict to a leading k-column bound, then rank/select on the suffix"
            , children =
                [ p []
                    [ text "The "
        ...
        , Fixpoint.Section.view
            { id = "perm"
            , title = "Permuted order statistics"
            , hint = "// order-by on a non-leading column via a permutation index"
            , children =
                [ p []
                    [ text "The "
        ...
        , Fixpoint.Section.view
            { id = "iter"
            , title = "Pull-iterator + merge-join"
            , hint = "// resumable cursor over a relation in ascending key order"
            , children =
                [ p []
                    [ text ""
                    , Fixpoint.Code.inline "dl_iter_*"
        ...
        , Fixpoint.Section.view
            { id = "range"
            , title = "Lazy OP_RANGE"
            , hint = "// range(X, Rel, Lo, Hi) is a lazy resumable generator"
            , children =
                [ p []
                    [ text "The Datalog "
                    , Fixpoint.Code.inline "range(X, Rel, Lo, Hi)"
...
typedProjectsView =
    div []
        [ Fixpoint.Hero.view
            ...
            , title = [ text "Typed Projects (", Fixpoint.Code.inline "dlp", text ")" ]
            , tagline = []
            }
        , Fixpoint.Section.view
            { id = "why"
            , title = "Why typed schemas?"
            , hint = "// typed, project-based workflow on top of the engine"
            , children =
                [ p []
                    [ Fixpoint.Code.inline "dlp"
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// a directory with a few conventional subdirectories"
            , children =
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// Dhall-as-data: self-contained lets with a final : Schema"
            , children =
                [ p []
                    [ text "The schema is "
        ...
        , Fixpoint.Section.view
            { id = "commands"
            , title = "Commands"
            , hint = "// init, schema, check, build, query"
            , children =
                [ table []
        ...
        , Fixpoint.Section.view
            ...
            , hint = "// mixed-type rules fail check/build with precise diagnostics"
            , children =
                [ p []
        ...
        , Fixpoint.Section.view
            { id = "build"
            , title = "Building dlp"
            , hint = "// opt-in cosmocc build; the default gcc make never touches it"
            , children =
                [ p []
                    [ Fixpoint.Code.inline "dlp"
